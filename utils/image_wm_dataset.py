...
class ImageWatermarkAttrDataset(Dataset):
    def __init__(self, img_dir, wm_dir, img_size=128, attr_path="celebahq"):
        ...
        if attr_path.startswith("celebahq"):
            self.attr_path = "/root/segfacemark_v/network/noise/stargan/CelebAMask-HQ-attribute-anno.txt"
        else:
            self.attr_path = "/root/segfacemark_v/network/noise/stargan/list_attr_celeba.txt"
