...
from Attention import ResBlock_CBAM
...
class Encoder(nn.Module):
    ...
    def forward(self, x, imgs, watermark):
        ...
        wm_ex_0 = F.interpolate(wm_ex_0, size=(H, W), mode="nearest")
        ...
        wm_ex_1 = F.interpolate(wm_ex_1, size=(H, W), mode="nearest")
        ...
        wm_ex_2 = F.interpolate(wm_ex_2, size=(H, W), mode="nearest")
