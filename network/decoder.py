...
from encoder import spatial_features_extractor
from encoder import Bottleneck
...
class Decoder(nn.Module):
    # def __init__(self, face_segmenter, pca_save_path="/root/autodl-tmp/watermark/train_128_30/pca_bundle.pkl"):
