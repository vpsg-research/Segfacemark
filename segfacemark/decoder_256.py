...
from segfacemark.encoder_256 import spatial_features_extractor
from segfacemark.encoder_256 import Bottleneck
...
class Decoder(nn.Module):
    def __init__(self, face_segmenter, pca_save_path="/root/autodl-tmp/watermark/train_256_128/pca_bundle.pkl", bg_attn_scale=1.5):
